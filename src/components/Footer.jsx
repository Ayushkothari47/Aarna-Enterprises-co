    ...
    <footer className="bg-gray-800 text-white py-10">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row md:justify-between gap-10 text-center md:text-left">
        ...
        <div className="md:flex-1 flex flex-col justify-start">
          <h2 className="text-2xl font-bold text-yellow-400 mb-2">Aarna Enterprises</h2>
          ...
          <p className="mt-3 text-gray-400 flex items-center gap-2">
            ...
            <a href="tel:+91 9717598168" className="hover:text-yellow-300 transition-colors">+91 9717598168</a>,<a href="tel:+91 8851622107" className="hover:text-yellow-300 transition-colors">+91 8851622107</a>
          </p>
